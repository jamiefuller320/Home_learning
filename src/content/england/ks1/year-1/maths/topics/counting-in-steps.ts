    ...
    check: [
      {
        ...
        nudge: "Say a number for each pair as you touch them: 2, 4, 6…",
      },
      {
        prompt: "Count in 5s to 20.",
        looksLike: "5, 10, 15, 20, perhaps looking at hands.",
        notYet: "They say 5, 6, 7 or 5, 10, 20.",
        nudge: "Count on five each time: 5, 10, 15, 20 — like five fingers on each hand.",
      },
      {
        ...
        nudge: "Make three groups of ten. Chant 10, 20, 30 as you point to each group.",
      },
    ],
