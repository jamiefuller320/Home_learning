    ...
    check: [
      {
        ...
        nudge: "Check the four pieces are the same size. Point to just one of them.",
      },
      {
        ...
        nudge: "Share eight into four equal groups. How many in one group?",
      },
      {
        ...
        nudge: "Cover half the square with two of the four equal pieces. Two quarters make a half.",
      },
    ],
