    ...
    check: [
      {
        ...
        nudge: "Count fourteen objects, then find the numeral that matches that amount.",
      },
      {
        ...
        nudge: "Twelve is 10 and 2 — look for the word that matches that amount, not a teen.",
      },
      {
        ...
        nudge: "Sixteen is six and ten. Look for 16, not 61.",
      },
    ],
